...

{
    ...
    "audioFileMetadata":{
        ...
        "duration":50,
        "host":"pk",
        "paticipant":["kuldeep", "Mali", "etc"]   # it's optional or can be blank or can be empty list.
    }
}
...
from-data : 
{
   "audioFileMetadata":{
        ...
        "duration":50,
        "host":"kuldeep",
        "paticipant":["kuldeep", "Mali", "pk"]   # it's optional or can be blank or can be empty list.
    }
}
